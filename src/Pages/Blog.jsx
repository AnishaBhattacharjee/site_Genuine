...
console.log("Intial Value",intialvlaue);
  ...
  return (
    ...
    <div className="breadcrumbs" data-aos="fade-in">
      ...
      <button onClick={() =>setIntialvlaue(intialvlaue+4)} style={{marginLeft:"380px",marginBottom:"50px",boxShadow:" 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19)",width:"230px"}} type="buttonn" class="btn btn-danger btn-rounded">Load More</button>
      <br/>
      </>}  
